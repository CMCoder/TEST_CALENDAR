...
@interface LECCalendarAppearance : NSObject

typedef NS_ENUM(NSInteger, LECCalendarWeekDayFormat) {
    LECCalendarWeekDayFormatSingle,
    LECCalendarWeekDayFormatShort,
    LECCalendarWeekDayFormatFull
};

typedef NSString *(^LECCalendarMonthBlock)(NSDate *date, LECCalendar *jt_calendar);
typedef BOOL(^LECCalendarDayExtesionBlock)(NSDate *date, LECCalendar *jt_calendar, NSArray *lines);
...
@property (nonatomic, copy) LECCalendarMonthBlock monthBlock;
@property (nonatomic, copy) LECCalendarDayExtesionBlock dayExBlock;

// Weekday
@property (assign, nonatomic) LECCalendarWeekDayFormat weekDayFormat;
